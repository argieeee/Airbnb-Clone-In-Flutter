...
class SubscribeProfile extends StatefulWidget {
  const SubscribeProfile({super.key});


  @override
  _SubscribeProfileState createState() => _SubscribeProfileState();
}

class _SubscribeProfileState extends State<SubscribeProfile> {
